...
function ProductB2BDetailsLayout({ productPartNumber, pdpData, storeId }: any) {
  ...
  const [skuAndQuantities, setSkuAndQuantities] =
    React.useState<Map<any, any>>(addToCartMap);
  ...
  const [attributeState, setAttributeState] =
    React.useState<Map<any, any>>(attributeChangeMap);
